...
const Description = () => {
    return (
        <div className="flex flex-col items-center justify-center my-12 p-6 md:px-28">
            ...
            <div className="flex flex-col lg:flex-row  gap-5 md:gap-14 items-center">
                <motion.img initial={{ opacity: 0.2, x: -200 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: .3 }} src={assets.sample_img_1} alt="Sample Image" className="w-80 xl:max-w-96 rounded-lg" />
                <motion.div className="max-w-[500px]" initial={{ opacity: 0.2, x: 200 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: .3 }}>
